...
CREATE INDEX IF NOT EXISTS "purge_runs_purge_runs_provider_created_at_index" ON "purge_runs" ("provider", "created_at");
CREATE UNIQUE INDEX IF NOT EXISTS "purge_runs_purge_runs_uuid_unique" ON "purge_runs" ("uuid");
