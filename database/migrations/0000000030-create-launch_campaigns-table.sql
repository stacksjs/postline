...
CREATE INDEX IF NOT EXISTS "launch_campaigns_status_start_date_index" ON "launch_campaigns" ("status", "start_date");
CREATE UNIQUE INDEX IF NOT EXISTS "launch_campaigns_uuid_unique" ON "launch_campaigns" ("uuid");
